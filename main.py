import os, sys, asyncio, logging, sqlite3, csv
...
print("MAIN_VERSION=2025-10-31-HTML-default", flush=True)
...
async def post_to_channel(bot: Bot, channel_id: int, item: dict) -> bool:
    try:
        await bot.send_message(chat_id=channel_id, text=format_post(item), disable_web_page_preview=False)
        return True
    except Exception as e:
